...
<div class="row g-3 settings-section">
    <div class="col-lg-7 mx-auto">
        <h1 class="app-page-title mb-4" style="text-align: center;">Edit Data Pelanggan</h1>
        <div class="app-card app-card-settings p-4">
            <div class="app-card-body">
                <form action="{{ route('pelanggan.update', $pelanggan_edit->id) }}" method="POST">
                    @csrf
                    @method('PUT')

                    <div class="mb-3">
                        <label for="nama" class="form-label"><small>Nama Pelanggan</small></label>
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama"
                            id="nama" value="{{ old('nama', $pelanggan_edit->nama) }}" required>
                        @error('nama')
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                    name="email" id="email" value="{{ old('email', $pelanggan_edit->email) }}">
                                @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('no_telp') is-invalid @enderror"
                                    name="no_telp" id="no_telp" value="{{ old('no_telp', $pelanggan_edit->no_telp) }}"
                                    required>
                                @error('no_telp')
                                <div class="invalid-feedback">
                                    {{ $message }}
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('kota') is-invalid @enderror" name="kota"
                            id="kota" value="{{ old('kota', $pelanggan_edit->kota) }}" required>
                        @error('kota')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat"
                            style="height: 7rem;" required>{{ old('alamat', $pelanggan_edit->alamat) }}</textarea>
                        @error('alamat')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group" style="text-align: center">
                        ...
                        <a href="{{ route('pelanggan.index') }}" class="btn btn-danger text-white"
                            role="button">Batal</a>
                    </div>
                </form>
            </div>
