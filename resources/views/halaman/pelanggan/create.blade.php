...
<div class="row g-3 settings-section">
    <div class="col-lg-7 mx-auto">
        <h1 class="app-page-title mb-4" style="text-align: center;">Tambah Data Pelanggan</h1>
        <div class="app-card app-card-settings p-4">
            <div class="app-card-body">
                <form action="/pelanggan" method="post">
                    @csrf
                    <div class="mb-3">
                        <label for="nama" class="form-label"><small>Input Kode Penjualan</small></label>
                        <select name="kode_penjualan" class="form-control selectCodeJual" id="kode_penjualan">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat"
                            style="height: 7rem;" required>{{ old('alamat') }}</textarea>
                        @error('alamat')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
