...
<div class="row g-3 settings-section">
    <div class="col-lg-7 mx-auto">
        <h1 class="app-page-title mb-4" style="text-align: center;">Tambah Data Biaya Lain-lain</h1>
        <div class="app-card app-card-settings p-4">
            <div class="app-card-body">
                <form action="/biaya-lain" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <input class="form-control" class='date' type="date" name="tgl_transaksi"
                                value="{{ old('tgl_transaksi') }}" min="1998-01-01" required>
                            @error('tgl_transaksi')
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <label for="nama" class="form-label"><small>Harga per Satuan</small></label>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">Rp </span>
                                </div>
                                <input type="text" class="form-control harga" name="harga" id="hargaInput"
                                    value="{{ old('harga') }}" data-type="currency" required>
                                @error('harga')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-sm-6">
                            <label for="nama" class="form-label"><small>Jumlah Item</small></label><br>
